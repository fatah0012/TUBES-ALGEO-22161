...
def matriks_balikan_2():
    ...
    if determinant == 0:
        print("Matriks tidak memiliki invers karena determinan adalah nol.")
        return
    ...
    inverse_matrix = [[cofactor_matrix[i][j] / determinant for j in range(3)] for i in range(3)]
...
def determinan_matriks_2():  
    ...
    print("Determinan matriks 3x3 adalah:", determinant)
